...
public class SqlLocalDBNativeDef {
    ...
    // The maximum size of SQL Server LocalDBManager connection string.
    public static final int LOCALDB_MAX_SQLCONNECTION_BUFFER_SIZE = 260;

    // The maximum size of SQL Server LocalDBManager instance names.
    public static final int MAX_LOCALDB_INSTANCE_NAME_LENGTH = 128;

    // The maximum size of an SQL Server LocalDBManager version string.
